package com.huahuacaocao.hhcc_common.base.adapter;
...
public class ViewHolder {
     ...
     * @return ViewHolder
     */
    public ViewHolder setImage(View view,String url){
...
//        Ion.with(mContext).load(url).intoImageView(imageView);
     ...
     * @return ViewHolder
     */
    public ViewHolder setImageResource(View view,int resourceId){
        ImageView imageView=(ImageView) view;
     ...
     * @return ViewHolder
     */
    public ViewHolder setImageBitmap(View view,Bitmap bitmap){
        ImageView imageView=(ImageView) view;
